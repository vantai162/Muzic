...
import com.example.muzic.data.model.explore.mood.genre.ItemsPlaylist
import com.example.muzic.data.model.explore.mood.genre.ItemsSong
import com.example.muzic.data.model.explore.mood.genre.Title
import com.example.muzic.data.model.explore.mood.moodmoments.Content
import com.example.muzic.data.model.explore.mood.moodmoments.Item
        ...
        if (items != null) {
            for (item in items) {
                if (item.musicCarouselShelfRenderer != null) {
                    ...
                    val listContent: MutableList<com.example.muzic.data.model.explore.mood.genre.Content> = mutableListOf()
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                // Song
                                ...
                                val playlistBrowseId =
                                    content.musicTwoRowItemRenderer
                                        ...
                                        ?.browseId
                                listContent.add(
                                    com.example.muzic.data.model.explore.mood.genre.Content(
                                        playlistBrowseId = playlistBrowseId ?: "",
