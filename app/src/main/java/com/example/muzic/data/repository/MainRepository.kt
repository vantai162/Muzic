package com.example.muzic.data.repository
...
import com.example.muzic.common.QUALITY
import com.example.muzic.common.VIDEO_QUALITY
import com.example.muzic.data.dataStore.DataStoreManager
import com.example.muzic.data.db.LocalDataSource
import com.example.muzic.data.db.MusicDatabase
import com.example.muzic.data.db.entities.AlbumEntity
import com.example.muzic.data.db.entities.ArtistEntity
import com.example.muzic.data.db.entities.FollowedArtistSingleAndAlbum
import com.example.muzic.data.db.entities.GoogleAccountEntity
import com.example.muzic.data.db.entities.LocalPlaylistEntity
import com.example.muzic.data.db.entities.LyricsEntity
import com.example.muzic.data.db.entities.NewFormatEntity
import com.example.muzic.data.db.entities.NotificationEntity
import com.example.muzic.data.db.entities.PairSongLocalPlaylist
import com.example.muzic.data.db.entities.PlaylistEntity
import com.example.muzic.data.db.entities.QueueEntity
import com.example.muzic.data.db.entities.SearchHistory
import com.example.muzic.data.db.entities.SetVideoIdEntity
import com.example.muzic.data.db.entities.SongEntity
import com.example.muzic.data.db.entities.SongInfoEntity
import com.example.muzic.data.model.browse.album.AlbumBrowse
import com.example.muzic.data.model.browse.album.Track
import com.example.muzic.data.model.browse.artist.ArtistBrowse
import com.example.muzic.data.model.browse.playlist.Author
import com.example.muzic.data.model.browse.playlist.PlaylistBrowse
import com.example.muzic.data.model.explore.mood.Genre
import com.example.muzic.data.model.explore.mood.Mood
import com.example.muzic.data.model.explore.mood.MoodsMoment
import com.example.muzic.data.model.explore.mood.genre.GenreObject
import com.example.muzic.data.model.explore.mood.moodmoments.MoodsMomentObject
import com.example.muzic.data.model.home.HomeItem
import com.example.muzic.data.model.home.chart.Chart
import com.example.muzic.data.model.metadata.Lyrics
import com.example.muzic.data.model.podcast.PodcastBrowse
...
import com.example.muzic.data.model.searchResult.playlists.PlaylistsResult
import com.example.muzic.data.model.searchResult.songs.Artist
import com.example.muzic.data.model.searchResult.songs.SongsResult
import com.example.muzic.data.model.searchResult.songs.Thumbnail
import com.example.muzic.data.model.searchResult.videos.VideosResult
import com.example.muzic.data.parser.parseAlbumData
import com.example.muzic.data.parser.parseArtistData
import com.example.muzic.data.parser.parseChart
import com.example.muzic.data.parser.parseGenreObject
import com.example.muzic.data.parser.parseLibraryPlaylist
import com.example.muzic.data.parser.parseMixedContent
import com.example.muzic.data.parser.parseMoodsMomentObject
import com.example.muzic.data.parser.parseNewRelease
import com.example.muzic.data.parser.parsePlaylistData
import com.example.muzic.data.parser.parsePodcast
import com.example.muzic.data.parser.parsePodcastContinueData
import com.example.muzic.data.parser.parsePodcastData
import com.example.muzic.data.parser.parseSetVideoId
import com.example.muzic.data.parser.search.parseSearchAlbum
import com.example.muzic.data.parser.search.parseSearchArtist
import com.example.muzic.data.parser.search.parseSearchPlaylist
import com.example.muzic.data.parser.search.parseSearchSong
import com.example.muzic.data.parser.search.parseSearchVideo
import com.example.muzic.data.parser.toListThumbnail
import com.example.muzic.data.type.PlaylistType
import com.example.muzic.data.type.RecentlyType
import com.example.muzic.extension.bestMatchingIndex
import com.example.muzic.extension.isNetworkAvailable
import com.example.muzic.extension.toListTrack
import com.example.muzic.extension.toLyrics
