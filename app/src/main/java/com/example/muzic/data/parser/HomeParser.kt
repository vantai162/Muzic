...
fun Thumbnail.toThumbnail(): com.example.muzic.data.model.searchResult.songs.Thumbnail =
    com.example.muzic.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.example.muzic.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.example.muzic.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
