...
import com.example.lyricsproviders.models.response.MusixmatchTranslationLyricsResponse
import com.example.muzic.R
import com.example.muzic.common.DownloadState
import com.example.muzic.common.SETTINGS_FILENAME
...
import com.example.muzic.data.model.browse.artist.ResultSong
import com.example.muzic.data.model.browse.artist.ResultVideo
import com.example.muzic.data.model.browse.playlist.PlaylistBrowse
import com.example.muzic.data.model.home.Content
...
import com.example.muzic.viewModel.ArtistScreenData
...
fun com.example.lyricsproviders.models.lyrics.Lyrics.toLyrics(): Lyrics {
...
fun com.example.spotify.model.response.spotify.SpotifyLyricsResponse.toLyrics(): Lyrics {
    val lines: ArrayList<Line> = arrayListOf()
    this.lyrics.lines.forEach {
        lines.add(
            Line(
