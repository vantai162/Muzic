...
import com.liskovsoft.googleapi.common.helpers.DefaultHeaders
...
internal object AppConstants {
     ...
     */
    @JvmField
    val JSON_POST_DATA_TEMPLATE_TV = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_TV, CLIENT_VERSION_TV, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_TV,
        JSON_POST_DATA_BROWSE
    )

    @JvmField
    val JSON_POST_DATA_TEMPLATE_WEB = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_WEB, CLIENT_VERSION_WEB, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_WEB,
        JSON_POST_DATA_BROWSE
    )

    @JvmField
    val JSON_POST_DATA_TEMPLATE_MWEB = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_MWEB, CLIENT_VERSION_WEB, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_MOBILE_WEB,
        JSON_POST_DATA_BROWSE
    )

    @JvmField
    val JSON_POST_DATA_TEMPLATE_ANDROID = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_ANDROID, CLIENT_VERSION_ANDROID, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_ANDROID,
        String.format(JSON_POST_DATA_ANDROID, ANDROID_SDK_VERSION) + JSON_POST_DATA_BROWSE
    )

    @JvmField
    val JSON_POST_DATA_TEMPLATE_KIDS = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_KIDS, CLIENT_VERSION_KIDS, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_TV,
        JSON_POST_DATA_BROWSE
    )

    @JvmField
    val JSON_POST_DATA_PLAYER_ANDROID = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_ANDROID, CLIENT_VERSION_ANDROID, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_ANDROID,
        String.format(JSON_POST_DATA_ANDROID, ANDROID_SDK_VERSION))

    @JvmField
    val JSON_POST_DATA_PLAYER_IOS = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_IOS, CLIENT_VERSION_IOS, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_IOS,
        String.format(JSON_POST_DATA_IOS, DEVICE_MODEL_IOS))

    @JvmField
    val JSON_POST_DATA_PLAYER_WEB = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_WEB, CLIENT_VERSION_WEB, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_WEB,
        "")

    @JvmField
    val JSON_POST_DATA_PLAYER_TV = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_TV, CLIENT_VERSION_TV, CLIENT_SCREEN_WATCH, DefaultHeaders.USER_AGENT_TV,
        "")

    @JvmField
    val JSON_POST_DATA_PLAYER_EMBED = String.format(
        JSON_POST_DATA_BASE, CLIENT_NAME_EMBED, CLIENT_VERSION_EMBED, CLIENT_SCREEN_EMBED, DefaultHeaders.USER_AGENT_WEB,
        "")
}